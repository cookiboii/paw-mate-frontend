...
export default function CommentComposer({
  ...
  return (
    <form
      className={reply ? styles.replyForm : styles.commentForm}
      onSubmit={(event) => void actions.handleSubmit(event, parentId)}
    >
      <input
        type="text"
        aria-label={reply ? '답글 내용' : '댓글 내용'}
        placeholder={
          reply ? '답글을 남겨주세요...' : '아이와 가족을 위한 따뜻한 응원의 말을 남겨주세요.'
        }
