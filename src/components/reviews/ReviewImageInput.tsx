...
interface Props { selection: ReturnType<typeof useImageSelection>; selectedCategory: PostCategory; isEditing: boolean }
export default function ReviewImageInput({ selection, selectedCategory, isEditing }: Props) {
  const { fileInputRef, isDragging, preview, handleImageChange, handleDragOver, handleDragLeave, handleDrop, removeImage } = selection;
  return (
