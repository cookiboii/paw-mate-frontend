...
import styles from '../../styles/components/HomeInfoSections.module.css';
      ...
      <section className={styles.principlesSection} ref={principlesRef}>
        ...
        <div className={styles.principlesGrid}>
          <article className={styles.principleCard}>
            ...
            <h4>철저한 사전 건강 검진</h4>
            <p>
              기본 접종, 중성화 여부, 기저 질환을 투명하게 확인하고 진료 기록을 보호자에게 온전히
              공유합니다.
            </p>
          </article>
          <article className={styles.principleCard}>
            ...
            <h4>책임감 있는 매칭 심사</h4>
            <p>
              주거 환경, 가족 구성원의 동의, 경제적 부양 능력을 종합적으로 고려하여 신중하게
              심사합니다.
            </p>
          </article>
          <article className={styles.principleCard}>
            ...
            <h4>직접 방문 및 교감</h4>
            <p>
              온라인 신청 후 보호소에서 아이와 직접 대면하여 서로의 기질과 환경이 맞는지 교감 시간을
              갖습니다.
            </p>
          </article>
          <article className={styles.principleCard}>
            ...
            <h4>평생 지속되는 사후 케어</h4>
            <p>
              입양 후에도 커뮤니티와 상담 창구를 통해 훈련, 건강, 돌봄에 필요한 정보를 함께
              나눕니다.
            </p>
          </article>
        </div>
      ...
      <section className={styles.howItWorks} ref={processRef}>
        ...
        <div className={styles.stepsGrid}>
          ...
          <article className={styles.stepCard}>
            ...
            <p>
              제출한 서류를 바탕으로 양육 환경과 적합성을 면밀히 심사하여 결과를 안내해 드립니다.
            </p>
          </article>
          <article className={styles.stepCard}>
