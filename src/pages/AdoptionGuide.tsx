  ...
  return (
    <div className={styles.guideContainer}>
      ...
      <div className={styles.timeline}>
        <div className={styles.step} ref={step1Ref}>
          ...
          <div className={styles.stepContent}>
            ...
            <p>
              보호소에 등록된 동물들의 건강 상태와 특징을 확인하고 입양 신청서를 작성합니다. 생활
              환경과 반려 경험을 정성껏 적어주시면 매칭에 큰 도움이 됩니다.
            </p>
          </div>
        </div>
        ...
        <div className={styles.step} ref={step2Ref}>
          ...
          <div className={styles.stepContent}>
            ...
            <p>
              제출해주신 신청서를 바탕으로 주거 환경, 동의 여부, 양육 적합성을 꼼꼼하게 검토하여
              심사 결과를 안내해 드립니다.
            </p>
          </div>
        </div>
        ...
        <div className={styles.step} ref={step3Ref}>
          ...
          <div className={styles.stepContent}>
            ...
            <p>
              보호소에 방문하여 아이와 첫인사를 나누고 교감 시간을 가집니다. 최종 입양 동의서 작성
              후 평생의 가족이 됩니다.
            </p>
          </div>
        </div>
      ...
      <div className={styles.noticeSection}>
        ...
        <ul>
          <li>
            반려동물은 장난감이 아닌 <strong>생명</strong>입니다. 평생 책임질 수 있는지 신중하게
            고민해 주세요.
          </li>
          <li>
            가족 구성원 <strong>모두의 동의</strong>가 반드시 필요합니다.
          </li>
          <li>
            입양 시 책임비가 발생할 수 있으며, 이는 구조 활동과 다른 유기동물들을 위해 사용됩니다.
          </li>
