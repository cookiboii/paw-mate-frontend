...
const FAQ: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    { q: '입양 절차가 어떻게 되나요?', a: '입양 안내 페이지에서 상세한 입양 과정을 확인하실 수 있습니다. 신청서 작성 후 담당자의 심사를 기다려주세요.' },
    { q: '입양 시 비용이 발생하나요?', a: '기본적인 접종 및 보호 비용의 일부로 소정의 책임비가 발생할 수 있으며, 구조된 다른 동물들을 위해 전액 사용됩니다.' },
    { q: '입양 조건을 충족하지 못하면 어떻게 되나요?', a: '심사를 통해 입양이 어렵다고 판단될 경우 반려될 수 있으며, 이는 동물의 복지를 위한 최우선의 결정임을 양해 부탁드립니다.' },
