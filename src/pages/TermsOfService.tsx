      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <h3>제1조 (목적)</h3>
            <p>
              본 약관은 AdoptMate(이하 "회사")가 제공하는 유기동물 입양 매칭 서비스(이하 "서비스")의
          ...
          <section className={styles.section}>
            ...
            <p>
              ② 회원은 가입 시 등록한 정보의 변경이 발생할 경우 즉시 갱신해야 하며, 이를 이행하지
              않아 발생하는 불이익은 회원의 책임으로 합니다.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p>
              ② 입양된 동물의 관리 책임은 전적으로 입양자에게 있으며, 파양 시 관련 법령에 따른
              책임이 부과될 수 있습니다.
            </p>
          </section>
          ...
          <section className={styles.section} id="privacy">
            ...
            <p>
              회사는 입양 심사 및 서비스 제공을 위해 최소한의 개인정보를 수집하며, 회원의 동의 없이
              제3자에게 제공하지 않습니다. 상세한 내용은 별도의 '개인정보처리방침'에 따릅니다.
            </p>
          </section>
        </div>
      </div>
